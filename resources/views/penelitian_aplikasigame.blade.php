...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="#">Sektor Aplikasi & Game</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 d-flex align-items-center">
                    <h3>Ayo temukan resource penelitian yang valid untuk pengembangan produk anda</h3>
                </div>
                <div class="col-3">
    ...
    <div class="penelitian container" style="margin-top: 50px;" >
        <div class="row">
            <div class="col-12">
                <hr />
                <h3 style="padding:10px">Daftar Penelitian - <span style="color: coral;">Sektor Aplikasi & Game</span> </h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div>
                            <h4>APLIKASI MOBILE GAME EDUKASI MATEMATIKA BERBASIS ANDROID</h4>
                            <small>1 Juni 2014</small>
                        </div>

                        <div>
                        <b>Yunis Aprilianti,  Uning Lestari, Catur Iswahyudi</b><br />
                        <small>Institut Sains & Teknologi AKPRIND</small>
                        </div>
                    </div>
                </div>
            </div>

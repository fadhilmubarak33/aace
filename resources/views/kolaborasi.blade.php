...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 d-flex align-items-center">
                    <h3>Mari temukan partner kolaborasimu agar dapat mengimplementasikan penelitian secara real !</h3>
                </div>
                <div class="col-3">
                    <img src="/Assets/kolaborasi_1.png">
                </div>
                <div class="col-3">
    ...
    <div class="penelitian container" style="margin-top: 50px;" >
        <div class="row">
            <div class="col-12">
                <hr />
                <h3 style="padding:10px">Daftar Kolaborasi</h3>
            </div>
        </div>
        <div class="row">
